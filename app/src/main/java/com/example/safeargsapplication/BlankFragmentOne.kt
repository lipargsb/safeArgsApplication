package com.example.safeargsapplication
...
view.findViewById<Button>(R.id.button2).setOnClickListener{
    //val amount = 10;
    val amount = 10;
   // val action = BlankFragmentTwoDirections.confirmationAction(amount)
    val action = BlankFragmentOneDirections.actionBlankFragmentOneToBlankFragmentTwo("Hello",amount)
